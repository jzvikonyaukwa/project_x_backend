...
public class ConsumableOnGrvExceptionHandling{

    @ResponseBody
    @ExceptionHandler(ConsumableOnGrvNotFoundException.class)
    @ResponseStatus(BAD_REQUEST)
    public ResponseEntity<String> runtime(ConsumableOnGrvNotFoundException e) {
